...
snBody = snBody.replace(/<h1>Enterprise Automation & Software<\/h1>/i, `<h1 style="font-family: 'Outfit', sans-serif !important; font-size: 4rem; color: #000000; margin-bottom: 0.5rem; line-height: 1.1;">Star Nexus<br>Technologies</h1>\n                    <div style="color: var(--color-primary); font-family: 'Outfit', sans-serif !important; font-weight: 700; font-size: 1.8rem; margin-bottom: 1rem;">Enterprise Automation & Software</div>`);
...
/* Explicitly enforce Star Nexus fonts (Outfit for headings, Inter for body) */
#software {
